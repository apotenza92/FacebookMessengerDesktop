...
!macro customInstall
  ...
  FileWrite $0 "$\r$\n"
  FileWrite $0 "# Fix taskbar shortcuts - UPDATE IN PLACE (don't delete, that breaks Windows tracking)$\r$\n"
  ...
  FileWrite $0 "    if ($$lnk.TargetPath -like $\"*Messenger*$\" -or $$lnk.TargetPath -like $\"*messenger*$\") {$\r$\n"
